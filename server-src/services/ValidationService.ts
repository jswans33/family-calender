...
export class ValidationService {
  ...
  static validateEventData(eventData: any): void {
    console.log('🔍 VALIDATION DEBUG - Incoming event data:', JSON.stringify(eventData, null, 2));
    ...
    if (!hasStartEnd && !hasDateTime) {
      console.error('❌ VALIDATION FAILED: Event must have either start/end times or date');
