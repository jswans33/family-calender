...
const App: React.FC = () => {
  ...
  useEffect(() => {
    const loadCalendars = async (): Promise<void> => {
      ...
      try {
        ...
        // Failed to load calendars - service will handle fallback
      }
  ...
  const handleCreateEvent = async (
    ...
    try {
      ...
      // Event creation failed - user notified
  ...
  const handleDeleteEvent = async (eventId: string) => {
    ...
    try {
      ...
      // Event deletion failed - user notified
  ...
  const handleUpdateEvent = async (updatedEvent: Partial<CalendarEvent>) => {
    ...
    try {
      ...
      // Update failed - no user notification needed
    }
  };
